##Cargamos datos
library(car)
data(Chile, package="car") #ver datos: Chile
...
#Grafico circular
with(Chile, pie(table(vote), labels=levels(vote), xlab="", ylab="", main="Intencion de voto", 
  col=palette()[2:5])) #se puede omitir xlab y ylab
...
#IGN. Toma vector de porcentaje de votos
...
#Grafico barras [voto segun educacion]
